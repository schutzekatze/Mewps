...
#ifndef INFRASTRUCTURE_PERIPHERALS_HARDWARE_SERIAL_COMM_H
 ...
 * If all attempts fail, the communication should abort and
...
#endif /* INFRASTRUCTURE_PERIPHERALS_HARDWARE_SERIAL_COMM_H */
